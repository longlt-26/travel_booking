<x-admin-layout title="Thêm Tour Mới">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
            <div class="p-10">
                <form method="POST" action="{{ route('admin.tours.store') }}" class="space-y-8" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <label for="imageInput" class="flex items-center gap-6 w-full bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl p-6 cursor-pointer hover:border-blue-600 transition-all overflow-hidden relative">
                                    <div class="w-24 h-24 rounded-xl overflow-hidden bg-slate-100 flex-shrink-0 border border-slate-200 flex items-center justify-center" id="previewWrapper">
                                    ...
                                    <div>
                                        <p class="text-sm font-black text-slate-500 group-hover:text-blue-600 transition">Nhấn để tải ảnh lên</p>
